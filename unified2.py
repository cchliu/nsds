...
class SpoolRecordReader(object):
    ...
    def __init__(self, directory, prefix, init_filename=None, init_offset=None, follow=False, rollover_hook= None):
        ...
        if init_filename:
            if os.path.exisits(os.path.join(self.directory, os.path.basename(init_filename))):
    ...
    def open_file(self, filename):
        ...
        self.fileobj = open(os.path.join(self.directory, os.path.basename(init_filename)), 'rb')
